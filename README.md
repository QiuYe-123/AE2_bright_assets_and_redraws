...
- **Original mod**: <https://github.com/AppliedEnergistics/Applied-Energistics-2>

### 2. AdvancedAE
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/pedroksl/AdvancedAE>

### 3. ExtendedAE
- Textures and Models
    - [Sea_Kerman](https://github.com/Sea-Kerman)
- **Original mod**: <https://github.com/GlodBlock/ExtendedAE>

### 4. AE Additions
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/the9grounds/AE-Additions>
...
- **Text and Translations**
    - [![License](https://img.shields.io/badge/License-No%20Restriction-green.svg?style=flat-square)](https://creativecommons.org/publicdomain/zero/1.0/)
- **Original mod**: <https://github.com/Mari023/AE2WirelessTerminalLibrary>

### 6. Applied Flux
- Refer to ExtendedAE
- **Original mod**: <https://github.com/GlodBlock/ExtendedAE/tree/appflux/1.21.1-neoforge>
...
- **Original mod**: <https://github.com/62832/MEGACells>

### 8. Applied Botanics Addon
- [![License](https://img.shields.io/badge/License-CC%20BY--NC--SA%203.0-yellow.svg?style=flat-square)](https://creativecommons.org/licenses/by-nc-sa/3.0/)
- **Original mod**: <https://github.com/ramidzkh/Applied-Botanics>

### 9. Applied Mekanistics
- [![License](https://img.shields.io/badge/License-CC%20BY--NC--SA%203.0-yellow.svg?style=flat-square)](https://creativecommons.org/licenses/by-nc-sa/3.0/)
- **Original mod**: <https://github.com/AppliedEnergistics/Applied-Mekanistics>

### 10. ME Requester
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/AlmostReliable/merequester>

### 11. AppliedE
- All assets are licensed under [CC BY-NC-SA 3.0], in adherence to the same license used by AE2 and with most deriving from AE2's and ProjectE's own assets. Some assets have been provided externally as courtesy of [Sea_Kerman](https://modrinth.com/user/Sea_Kerman).
- **Original mod**: <https://github.com/62832/AppliedE/>

### 12. ExtendedAE_plus
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/GaLicn/ExtendedAE_Plus>

### 13. ME Beam Former
- Refer to Applied Energistics 2
- **Original mod**: <https://modrinth.com/mod/me-beam-former>

### 14. AE_Wireless_Transceiver
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/mynamexiaopiao/AE-Wireless-Transceiver>
...
- **Original mod**: <https://github.com/Lapis256/AE2ToggleableViewCell>

### 16. Useless_Mod
- MIT License
- **Original mod**: <https://modrinth.com/mod/a-useless-mod>

### 17. GTOEX——(Unpublished)
- MIT License
- **Original mod**: <https://github.com/LiN-lN/GTOEX/releases>

### 18. ArsEnergistique
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/62832/ArsEnergistique>

### 19. AdvancedMemoryCard
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/suntide-20210418/AdvancedMemoryCard>

### 20. AE2 Generators
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/ExpertTrout9232/AE2-Generators>
...
- **Original mod**: <https://github.com/Lapis256/AE2MEGAThings>

### 22. AE2 Crystal Science
- All Rights Reserved
- Authorization has been obtained
- **Original mod**: <https://github.com/Frostbite-time/AE2-Crystal-Science>

### 23. AE2 Import Export Card
- MIT License
- **Original mod**: <https://github.com/starforcraft/AE2-Import-Export-Card>

### 24. AE2 netanalyser
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/GlodBlock/ExtendedAE/tree/analyser/1.20.1-forge>

### 25. AE2PatternEncodingAccessTerminal
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/yuuki1293/AE2PatternEncodingAccessTerminal>

### 26. AE2Things
- MIT License
- **Original mod**: <https://github.com/Technici4n/AE2Things-Forge>

### 27. AdditionalEntityAttributes
- MIT License
- **Original mod**: <https://github.com/DaFuqs/AdditionalEntityAttributes>

### 28. aehelpers-more
- MIT License
- **Original mod**: <https://github.com/mynamexiaopiao/aehelpers-more>

### 29. Applied-Extended-Crafting
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/GaLicn/Applied-Extended-Crafting>

### 30. AppliedCooking
- MIT License
- **Original mod**: <https://github.com/Sebastrn/AppliedCooking>

### 31. Applied Create
- All Rights Reserved
- Authorization has been obtained
- **Original mod**: <https://www.curseforge.com/minecraft/mc-mods/applied-create>

### 32. applied-sorting
- MIT License
- **Original mod**: <https://github.com/Meatwo310/applied-sorting>

### 33. AppliedSoul
- MIT License
- **Original mod**: <https://github.com/Y-Xiao233/AppliedSoul>

### 34. AppliedWebTerminal
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/ZhuRuoLing/AppliedWebTerminal>

### 35. BetterModificationTool
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/Savitor-SN/BetterModificationTool>

### 36. BetterP2P
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/LasmGratel/BetterP2P>

### 37. Expanded AE
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/ko-lja/expandedae>

### 38. ExtendedTerminal
- Refer to Applied Energistics 2
- Assets  
  AE2: [See Details ![Badge](https://img.shields.io/badge/License-CC%20BY--NC--SA%203.0-green?style=flat-square)]
- **Original mod**: <https://github.com/mc-myo-s-mod/ExtendedTerminal>

### 39. gtlcore
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/EasterFG/GTLCore>

### 40. IFSoulsDisks
- MIT License
- **Original mod**: <https://github.com/Rerurate514/IFSoulsDisks>

### 41. infinitypattern
- MIT License
- **Original mod**: <https://github.com/2884omgpy/Infinity_Pattern_Provider>
...
- **Original mod**: <https://github.com/Monifactory/MAE2>

### 44. More AE2 Additions
- Refer to Applied Energistics 2
- **Original mod**: <https://github.com/EasterFG/More-AE2-Additions>

### 45. MEInfinityCell
- MIT License
- **Original mod**: <https://github.com/Y-Xiao233/MEInfinityCell>
...
- **Original mod**: <https://github.com/MOAKIEE/ME-Placement-Tool>

### 47. ProgrammedCircuitCard
- MIT License
- **Original mod**: <https://github.com/yuuki1293/ProgrammedCircuitCard>

### 48. personalmesystem
- MIT License
- **Original mod**: <https://github.com/game-design-driven/ae2-personal-me-system>

### 49. Polymorph
- GNU LGPL V3.0 License
- **Original mod**: <https://github.com/illusivesoulworks/polymorph>

### 50. unae2addon
- All Rights Reserved
- Completely redrawn, not affected by the project license. This redrawn texture is licensed under MIT.
- **Original mod**: <https://www.curseforge.com/minecraft/mc-mods/unae2addon>

### 51. Wildcard Pattern
- MIT License
- **Original mod**: <https://github.com/LeoDreamer2004/Wildcard-Pattern>
